...
def generate_key(name, email, passphrase, algorithm="RSAEncryptOrSign", key_size=2048, expiration=None, compression="ZLIB", comment=None):
    ...
    # Convert compression parameter to pgpy.constants.CompressionAlgorithm
    compression_algo = getattr(pgpy.constants.CompressionAlgorithm, compression, pgpy.constants.CompressionAlgorithm.ZLIB)

    key.add_uid(uid, usage={pgpy.constants.KeyFlags.Sign, pgpy.constants.KeyFlags.EncryptCommunications}, hash_alg=pgpy.constants.HashAlgorithm.SHA256, ciphers=[pgpy.constants.SymmetricKeyAlgorithm.AES256], compression=[compression_algo], key_expiration=expiration)
